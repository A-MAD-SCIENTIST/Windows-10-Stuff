...
$Form.ClientSize = '470,523'
$Form.ClientSize = '470,523'
$Form.text = "Debloat W10 Apps GUI - K Levelle/Kath"
$Form.TopMost = $false
...
$Debloat.Font = 'segoeui,12,style=Bold,Underline'
...
$RemoveAllBloatware.Font = 'segoeui,10'
...
$Label1.text = "Revert Changes. Rweally?"
...
$Label2.text = "Privacy stuff and uhm, stuff xd"
...
$DisableCortana.text = "Disable Cortana NOW!"
...
$EnableCortana.text = "Enable Cortana. NO NO NO!!!"
...
$StopEdgePDFTakeover.text = "Prevent Edge PDF Takeover"
...
$EnableEdgePDFTakeover.text = "Enable Edge PDF. Edge going soon, wrip haaaa"
...
$DisableTelemetry.text = "Disable Telemetry & Stupid Tasks"
...
$RemoveAllBloatware.Add_Click( { 
        ...
        Protect-Privacy
        #Write-Host "Gonna liek now hack and staph Edgey from taking over as the  default PDF Viewer."
        #Stop-EdgePDF
...
$DisableCortana.Add_Click( { 
        ...
        Write-Host "Cortana has been disabled. SO IT SHULLDDDDD BEEEAHHH. wut? `n"
    })
